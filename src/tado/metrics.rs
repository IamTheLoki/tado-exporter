...
mod tests {
    use crate::tado::model::{
        WeatherApiResponse, WeatherOutsideTemperatureApiResponse, WeatherSolarIntensityApiResponse,
    };
    ...
    fn test_set_weather_some() {
        ...
        */
        ...
        assert_eq!(outside_temp_celsius.get_gauge().get(), 20.0);
